...
\BeginKnitrBlock{example}<div class="example"><span class="example" id="exm:exemptemp"><strong>(\#exm:exemptemp) </strong></span>Vamos supor que desejamos medir a temperatura máxima do ar, de um local,
